...
//    }
    ...
    //claims is basically a interface that implements Map through which we can extract the claims that we saved in our map
    ...
    // Claims::getExpiration  ,is  a method reference that refers to the getExpiration() method inside the claims interface
