...
//       };
    ...
    // AuthenticationConfiguration is a Spring Security class that auto-configures AuthenticationManager.
    // config.getAuthenticationManager() automatically detects and injects the AuthenticationProvider bean.
     @Bean
